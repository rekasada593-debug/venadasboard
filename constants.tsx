...
export const MOCK_USERS: User[] = [
    { id: 'USR001', email: 'info@andiwijayaphoto.com', password: 'admin', fullName: 'Andi Wijaya', companyName: 'Andi Wijaya Photography', role: 'Admin' },
    { id: 'USR002', email: 'asisten@andiwijayaphoto.com', password: 'member', fullName: 'Rina Asisten', companyName: 'Andi Wijaya Photography', role: 'Member', permissions: [ViewType.CLIENTS, ViewType.PROJECTS, ViewType.CALENDAR, ViewType.SOCIAL_MEDIA_PLANNER] },
];
...
const MOCK_USER_PROFILE: VendorData['profile'] = {
    ...
    email: 'info@andiwijayaphoto.com',
    phone: '081288889999',
    companyName: 'Andi Wijaya Photography',
    website: 'https://andiwijayaphoto.com',
    address: 'Jl. Kreatif No. 10, Jakarta Pusat',
    bankAccount: 'BCA - 9876543210 a/n Andi Wijaya',
    authorizedSigner: 'Andi Wijaya',
    idNumber: '3171234567890002',
    bio: 'Mengabadikan momen dengan sentuhan sinematik. Spesialis pernikahan dan prewedding di seluruh Indonesia.',
...
export const MOCK_DATA: VendorData = {
    ...
    transactions: [
        ...
        { id: 'TRN009', date: new Date(new Date().setDate(new Date().getDate() - 19)).toISOString(), description: 'Biaya Akomodasi - Proyek Farhan & Aisyah', amount: 750000, type: TransactionType.EXPENSE, projectId: PROJ_5_ID, category: 'Akomodasi', method: 'Tunai', cardId: 'CARD_CASH' },
    ...
    teamPaymentRecords: [
        { id: 'TPR001', recordNumber: 'PAY-FR-001', teamMemberId: TEAM_1_ID, date: new Date(new Date().setDate(new Date().getDate() - 50)).toISOString(), projectPaymentIds: ['TPP001', 'TPP008'], totalAmount: 3000000, vendorSignature: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==' },
